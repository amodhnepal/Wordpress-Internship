        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6">
                <div class="grids5-info">
                    <a href="#destination" class="place-image d-block zoom"><img src="<?php echo get_template_directory_uri()?>/assets/images/s1.jpg" alt=""
            ...
            <div class="col-lg-4 col-sm-6 mt-sm-0 mt-4">
                <div class="grids5-info">
                    <a href="#destination" class="place-image d-block zoom"><img src="<?php echo get_template_directory_uri()?>/assets/images/s2.jpg" alt=""
                            class="img-fluid radius-image" />
                        <div class="image-overlay">
                            <h4>Singapore</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, consectetur.</p>
            ...
            <div class="col-lg-4 col-sm-6 mt-lg-0 mt-4">
                <div class="grids5-info">
                    <a href="#destination" class="place-image d-block zoom"><img src="<?php echo get_template_directory_uri()?>/assets/images/s3.jpg" alt=""
                            class="img-fluid radius-image" />
                        <div class="image-overlay">
                            <h4>France</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, consectetur.</p>
            ...
            <div class="col-lg-4 col-sm-6 mt-4">
                <div class="grids5-info">
                    <a href="#destination" class="place-image d-block zoom"><img src="<?php echo get_template_directory_uri()?>/assets/images/blog3.jpg"
            ...
            <div class="col-lg-4 col-sm-6 mt-4">
                <div class="grids5-info">
                    <a href="#destination" class="place-image d-block zoom"><img src="<?php echo get_template_directory_uri()?>/assets/images/blog2.jpg"
                            alt="" class="img-fluid radius-image" />
                        <div class="image-overlay">
                            <h4>USA</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, consectetur.</p>
            ...
            <div class="col-lg-4 col-sm-6 mt-4">
                <div class="grids5-info">
                    <a href="#destination" class="place-image d-block zoom"><img src="<?php echo get_template_directory_uri()?>/assets/images/blog1.jpg"
                            alt="" class="img-fluid radius-image" />
                        <div class="image-overlay">
                            <h4>London</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, consectetur.</p>
